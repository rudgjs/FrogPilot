...
class CarController:
  ...
  def calc_pedal_command(accel: float, long_active: bool, car_velocity) -> float:
    ...
    DecelZero = interp(car_velocity, [0., 3, 10, 15, 30], [0.05, 0.200, 0.245, 0.25, 0.280])
    AccelZero = interp(car_velocity, [0., 3, 10, 15, 30], [0.05, 0.130, 0.175, 0.200, 0.280])
    ZeroRatio = interp(accel, [-3.0, 1.5], [1.0, 0.0])
